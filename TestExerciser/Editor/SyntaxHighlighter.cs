...
namespace EditorNS
{
    public class SyntaxHighlighter : IDisposable
    {
        ...
        protected Regex PythonAttributeRegex;
        protected Regex PythonCommentRegex1;
        protected Regex PythonCommentRegex2;
        protected Regex PythonCommentRegex3;
...
";
        ...
        {
            PythonStringRegex = new Regex(@"""""|"".*?[^\\]""|'.*?[^\\]'", RegexCompiledOption);
            PythonCommentRegex1 = new Regex(@"#.*$", RegexOptions.Multiline | RegexCompiledOption);
            PythonCommentRegex2 = new Regex(@"'''[^''']*'''", RegexOptions.Singleline | RegexCompiledOption);
            //PythonCommentRegex3 = new Regex(@"", RegexOptions.Multiline | RegexCompiledOption);
            PythonNumberRegex = new Regex(@"\b\d+[\.]?\d*([eE]\-?\d+)?[lLdDfF]?\b|\b0x[a-fA-F\d]+\b",
                                          RegexCompiledOption);
...
";
            ...
            //comment highlighting
            range.SetStyle(CommentStyle, PythonCommentRegex1);
            range.SetStyle(CommentStyle, PythonCommentRegex2);
            //range.SetStyle(CommentStyle, PythonCommentRegex3);
            //number highlighting
            range.SetStyle(NumberStyle, PythonNumberRegex);
            //attribute highlighting
            range.SetStyle(AttributeStyle, PythonAttributeRegex);
            //class name highlighting
